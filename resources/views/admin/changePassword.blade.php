    ...
    <div class="px-80">
        ...
        <form action="{{ route('admin.updatePassword') }}" method="POST">
            ...
            <div class="w-full bg-white-900 border border-gray-200 rounded-lg shadow sm:p-6 md:p-8">
                ...
                <h5 class="text-xl font-bold text-gray-90 px-12 text-center">Set New Password</h5>
                <div>
                    <label for="password" class="block mb-2 text-lg font-medium text-gray-900 my-4">New Password</label>
                    <div class="relative">
                ...
                <div>
                    <label for="password_confirmation" class="block mb-2 text-lg font-medium text-gray-900 my-4">Confirm New
                        Password</label>
                    <div class="relative">
